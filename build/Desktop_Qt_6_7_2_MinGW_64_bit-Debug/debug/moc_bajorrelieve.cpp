...
struct qt_meta_stringdata_CLASSBajoRrelieveENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSBajoRrelieveENDCLASS = QtMocHelpers::stringData(
    "BajoRrelieve",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSBajoRrelieveENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject BajoRrelieve::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSBajoRrelieveENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSBajoRrelieveENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSBajoRrelieveENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<BajoRrelieve, std::true_type>,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_BajoRrelieve_accepted'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_BajoRrelieve_rejected'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void BajoRrelieve::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->on_BajoRrelieve_accepted(); break;
        case 6: _t->on_BajoRrelieve_rejected(); break;
        default: ;
        }
    }
}
...
void *BajoRrelieve::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSBajoRrelieveENDCLASS.stringdata0))
