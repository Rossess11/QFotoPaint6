...
struct qt_meta_stringdata_CLASSbrillocontrasteENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSbrillocontrasteENDCLASS = QtMocHelpers::stringData(
    "brillocontraste",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSbrillocontrasteENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject brillocontraste::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSbrillocontrasteENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSbrillocontrasteENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSbrillocontrasteENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<brillocontraste, std::true_type>,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'on_brillocontraste_accepted'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_brillocontraste_rejected'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void *brillocontraste::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSbrillocontrasteENDCLASS.stringdata0))
