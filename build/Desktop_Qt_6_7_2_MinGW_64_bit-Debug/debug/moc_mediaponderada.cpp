...
struct qt_meta_stringdata_CLASSmediaponderadaENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmediaponderadaENDCLASS = QtMocHelpers::stringData(
    "mediaponderada",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmediaponderadaENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mediaponderada::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSmediaponderadaENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmediaponderadaENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmediaponderadaENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<mediaponderada, std::true_type>,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'on_mediaponderada_accepted'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void *mediaponderada::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmediaponderadaENDCLASS.stringdata0))
